...
// Database connection
$host = 'localhost';
$port = 3307; // Make sure this port is correct for your XAMPP setup
$dbName = 'user_auth';
$dbUser = 'root';
$dbPass = '';
...
try {
    ...
    $sql = "SELECT * FROM users WHERE id = :id"; // Change 'user_auth' to 'users'
...
<body>
    ...
    <div class="container">
        ...
        <?php if ($rsvp === false): ?>
            <p style="color: red;">We are very sorry that you are not listed to be one of the guests.</p>
        <?php else: ?>
